...
import org.sample.mqtt.AndesMQTTClient;
import org.sample.mqtt.MQTTSampleConstants;
		...
		statusUpdateSchedule = scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
			public void run() {
				try {
					...
					mqttClient.sendMessage(generateTopicHierarchy(ENGINE_TEMPERATURE), org.sample.mqtt.AndesMQTTClient.TEMPERATURE_PREFIX + String.valueOf(getEngineTemperature()), qos);

					// Send speed reading
					mqttClient.sendMessage(generateTopicHierarchy(SPEED), org.sample.mqtt.AndesMQTTClient.SPEED_PREFIX + String.valueOf(getSpeed()), qos);

					// Send acceleration reading
					mqttClient.sendMessage(generateTopicHierarchy(ACCELERATION), org.sample.mqtt.AndesMQTTClient.ACCELERATION_PREFIX + String.valueOf(getAcceleration()), qos);
